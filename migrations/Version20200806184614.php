 ...
 */
final class Version20200806184614 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, appointment_id INT DEFAULT NULL, number VARCHAR(255) NOT NULL, booking VARCHAR(255) NOT NULL, quantity INT NOT NULL, incoterm_date DATE NOT NULL, forwarder VARCHAR(255) NOT NULL, warehouse VARCHAR(255) NOT NULL, shipment VARCHAR(255) DEFAULT NULL, incoterm VARCHAR(255) NOT NULL, is_free TINYINT(1) NOT NULL, INDEX IDX_F5299398E5B533F9 (appointment_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
