 ...
 */
final class Version20200806185822 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE appointment ADD created_at DATETIME NOT NULL, ADD updated_at DATETIME NOT NULL');
